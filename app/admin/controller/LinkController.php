...
class LinkController extends AdminBaseController
{
    ...
    public function addPost()
    {
        ...
        $this->success("添加成功！", url("link/index",array('type_id'=>$data['type_id'])));
    }
    ...
    public function editPost()
    {
        ...
        $this->success("保存成功！", url("link/index",array('type_id'=>$data['type_id'])));
    }
    ...
    public function delete()
    {
        ...
        $this->success("删除成功！", url("link/index",array('type_id'=>$type_id)));
    }
