...
class AdminCategoryfaController extends AdminBaseController
{
    /**
     * 文章分类列表
     * @adminMenu(
    ...
    public function add()
    {
        ...
        $listThemeFiles    = $themeModel->getActionThemeFiles('portal/Listfa/index');
    ...
    public function addPost()
    {
        ...
        $result = $this->validate($data, 'PortalCategoryfa');
        ...
        $this->success('添加成功!', url('AdminCategoryfa/index'));
    ...
    public function edit()
    {
        ...
        if ($id > 0) {
            $category = PortalCategoryfaModel::get($id)->toArray();
...
//     }
    ...
    {
        parent::listOrders(Db::name('portal_categoryfa'));
        $this->success("排序更新成功！", '');
    }
...
//判断此分类有无子分类（不算被删除的子分类）
        ...
        $categoryPostCount = Db::name('portal_categoryfa_post')->where('category_id', $id)->count();
