...
class AdminConweController extends AdminBaseController
{
    /**
     * 文章列表
     * @adminMenu(
    ...
    public function addPost()
    {
        if ($this->request->isPost()) {
            ...
            $this->success('添加成功!', url('AdminConwe/index'));
        }
    ...
    public function editPost()
    {
        ...
        if ($this->request->isPost()) {
            ...
            $this->success('保存成功!',url('AdminConwe/index'));
