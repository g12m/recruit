...
class PortalPostfaModel extends Model
{
    ...
    {
        return $this->belongsToMany('PortalCategoryfaModel', 'portal_categoryfa_post', 'category_id', 'post_id');
    }
     ...
     * @return string
     */
    public function getPostCaseAttr($value)
    {
        return cmf_replace_content_file_url(htmlspecialchars_decode($value));
    }
     ...
     * @return string
     */
    public function setPostCaseAttr($value)
    {
        return htmlspecialchars(cmf_replace_content_file_url(htmlspecialchars_decode($value), true));
    }
 ...
 * @return string
 */
public function getPostXingAttr($value)
{
    return cmf_replace_content_file_url(htmlspecialchars_decode($value));
}
 ...
 * @return string
 */
public function setPostXingAttr($value)
{
    return htmlspecialchars(cmf_replace_content_file_url(htmlspecialchars_decode($value), true));
}
//开营时间
 ...
 * @return string
 */
public function getPostPayAttr($value)
{
    return cmf_replace_content_file_url(htmlspecialchars_decode($value));
}
 ...
 * @return string
 */
public function setPostPayAttr($value)
{
    return htmlspecialchars(cmf_replace_content_file_url(htmlspecialchars_decode($value), true));
}
//6
 ...
 * @return string
 */
public function getPostApplyAttr($value)
{
    return cmf_replace_content_file_url(htmlspecialchars_decode($value));
}
 ...
 * @return string
 */
public function setPostApplyAttr($value)
{
    return htmlspecialchars(cmf_replace_content_file_url(htmlspecialchars_decode($value), true));
}
//6
 ...
 * @return string
 */
public function getPostBaomingAttr($value)
{
    return cmf_replace_content_file_url(htmlspecialchars_decode($value));
}
 ...
 * @return string
 */
public function setPostBaomingAttr($value)
{
    return htmlspecialchars(cmf_replace_content_file_url(htmlspecialchars_decode($value), true));
}
     ...
     * @return $this
     */
    public function adminAddPage($data,$categories)
    {
        $data['user_id'] = cmf_get_current_admin_id();
     ...
     * @return $this
     */
    public function adminEditPage($data,$categories)
    {
        $data['user_id'] = cmf_get_current_admin_id();
        ...
        // ------页面分类处理----------
        $oldCategoryIds        = $this->categories()->column('category_id');
        $this->categories()->detach($oldCategoryIds);
