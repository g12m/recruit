<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:29:"themes/index/portal\list.html";i:1599199034;s:72:"E:\phpStudy\PHPTutorial\WWW\zhaopin\public\themes\index\public\base.html";i:1599199035;s:72:"E:\phpStudy\PHPTutorial\WWW\zhaopin\public\themes\index\public\head.html";i:1599199035;s:79:"E:\phpStudy\PHPTutorial\WWW\zhaopin\public\themes\index\public\header_list.html";i:1599199035;s:74:"E:\phpStudy\PHPTutorial\WWW\zhaopin\public\themes\index\public\banner.html";i:1599199035;s:74:"E:\phpStudy\PHPTutorial\WWW\zhaopin\public\themes\index\public\footer.html";i:1599199035;}*/ ?>
<!DOCTYPE html>
<html>
...
<div data-scroll-reveal="enter bottom" class="banner">
  ...
  <?php endif; ?>
    ...
    <div class="liebiao" style="background-image: url(/themes/index/public/assets/images/default/chanpin_bg.jpg); background-repeat: no-repeat;">
        <div class="container">
            <div data-scroll-reveal="enter left" class="top">
                ...
                <p>
                    <?php
$portal_sub_categories_data = \app\portal\service\ApiService::subCategories(2);
 ...
 if(is_array($portal_sub_categories_data) || $portal_sub_categories_data instanceof \think\Collection || $portal_sub_categories_data instanceof \think\Paginator): $i = 0; $__LIST__ = $portal_sub_categories_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                        ...
                        <a <?php if($vo['id']==$category['id']): ?>class="active"<?php endif; ?>
                            href="<?php echo cmf_url('portal/List/index',array('id'=>$vo['id'])); ?>"><?php echo $vo['name']; ?></a>
 ...
 if(is_array($articles_data['articles']) || $articles_data['articles'] instanceof \think\Collection || $articles_data['articles'] instanceof \think\Paginator): $i = 0; $__LIST__ = $articles_data['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                ...
                <div class="clearfix">
                    <div data-scroll-reveal="enter left" class="fl">
                        <div class="img">
                        <a href="<?php echo cmf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$category['id'])); ?>"> <img src="<?php echo cmf_get_image_url($vo['more']['thumbnail']); ?>"></a>
                        </div>
                    </div>
                    <div data-scroll-reveal="enter right" class="fr">
                        <div class="clearfix">
                            <a href="<?php echo cmf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$category['id'])); ?>"><h3 class="fl"><?php echo $vo['post_title']; ?></h3></a>
                            <span class="fr"><?php echo date("Y-m-d",$vo['published_time']); ?></span>
                        </div>
                        <p><?php echo $vo['post_excerpt']; ?></p>
                        <a data-scroll-reveal="enter right" class="geng box" href="<?php echo cmf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$category['id'])); ?>"
