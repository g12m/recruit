<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"themes/admin/portal\admin_conween\index.html";i:1545719738;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\admin\public\header.html";i:1543480324;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li><a href="<?php echo url('AdminConween/add'); ?>">添加文章</a></li>
    </ul>
    <form class="well form-inline margin-top-20" method="post" action="<?php echo url('AdminConween/index'); ?>">
        分类:
        ...
        <a class="btn btn-danger" href="<?php echo url('AdminConween/index'); ?>">清空</a>
    </form>
        ...
        <div class="table-actions">
            <?php if(!(empty($category) || (($category instanceof \think\Collection || $category instanceof \think\Paginator ) && $category->isEmpty()))): ?>
                <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                        data-action="<?php echo url('AdminConween/listOrder'); ?>"><?php echo lang('SORT'); ?>
                </button>
            <?php endif; ?>
            <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminConween/publish',array('yes'=>1)); ?>" data-subcheck="true">发布
            </button>
            <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminConween/publish',array('no'=>1)); ?>" data-subcheck="true">取消发布
            </button>
            <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminConween/top',array('yes'=>1)); ?>" data-subcheck="true">置顶
            </button>
            <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminConween/top',array('no'=>1)); ?>" data-subcheck="true">取消置顶
            </button>
            <!-- <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminConween/recommend',array('yes'=>1)); ?>" data-subcheck="true">推荐
            </button>
            <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminConween/recommend',array('no'=>1)); ?>" data-subcheck="true">取消推荐
            </button> -->
            <!--
            <?php if(!(empty($category) || (($category instanceof \think\Collection || $category instanceof \think\Paginator ) && $category->isEmpty()))): ?>
            ...
            <button class="btn btn-danger btn-sm js-ajax-submit" type="submit"
                    data-action="<?php echo url('AdminConween/delete'); ?>" data-subcheck="true" data-msg="您确定删除吗？">
        ...
        <table class="table table-hover table-bordered table-list">
            ...
            <?php if(is_array($articles) || $articles instanceof \think\Collection || $articles instanceof \think\Paginator): if( count($articles)==0 ) : echo "" ;else: foreach($articles as $key=>$vo): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo url('AdminConween/edit',array('id'=>$vo['id'])); ?>"><?php echo lang('EDIT'); ?></a>
                        <a href="<?php echo url('AdminConween/delete',array('id'=>$vo['id'])); ?>" class="js-ajax-delete"><?php echo lang('DELETE'); ?></a>
                    </td>
                </tr>
            <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    $(function () {
        ...
        Wind.use('ajaxForm', 'artDialog', 'iframeTools', function () {
            ...
            $('.js-articles-copy').click(function (e) {
                ...
                ids = ids.join(',');
                art.dialog.open("/index.php?g=portal&m=AdminConween&a=copy&ids=" + ids, {
                    title: "批量复制",
                    width: "300px"
                });
            });
            ...
            $('.js-articles-move').click(function (e) {
                ...
                ids = ids.join(',');
                art.dialog.open("/index.php?g=portal&m=AdminConween&a=move&old_term_id=<?php echo (isset($term['term_id']) && ($term['term_id'] !== '')?$term['term_id']:0); ?>&ids=" + ids, {
                    title: "批量移动",
                    width: "300px"
                });
            });
