<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"themes/admin/portal\admin_source\edit.html";i:1560925276;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\admin\public\header.html";i:1543480324;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('AdminSource/index'); ?>">文章管理</a></li>
        <li>
            <a href="<?php echo url('AdminSource/add'); ?>">添加文章</a>
        </li>
        <li class="active"><a href="#">编辑文章</a></li>
    </ul>
    <form action="<?php echo url('AdminSource/editPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                <table class="table table-bordered">
                    ...
                    <tr>
                      ...
                      <?php if($post_category_ids==10 || $post_category_ids==11 || $post_category_ids==12 || $post_category_ids==13 || $post_category_ids==14): ?>
                    <tr id="phone">
                        <th>电话</th>
                        <td>
                            <input class="form-control" type="text" name="post[post_phone]" id="phone"
                                   placeholder="请输入电话"   value="<?php echo $post['post_phone']; ?>">
                    ...
                    <tr id="email">
                        ...
                        <td>
                            <input class="form-control" type="text" name="post[post_email]" id="email"
                                   placeholder="请输入邮箱"  value="<?php echo $post['post_email']; ?>">
                            <p class="help-block"></p>
                        </td>
                    </tr>
                    <tr id="url">
                        ...
                        <td>
                            <input class="form-control" type="text" name="post[post_url]" id="url"
                                   placeholder="请输入官方网址"  value="<?php echo $post['post_url']; ?>">
                            <p class="help-block"></p>
                        </td>
                    </tr>
                    <?php endif; ?>
            ...
            <div class="col-md-3">
                <table class="table table-bordered">
                    ...
                    <tr id="template">
                        <td>
                        <input class="form-control" type="text" name="post[post_url]" value="<?php echo $post['post_url']; ?>" placeholder="请输入外部链接：http://">
                        </td>
                    </tr>
                    <tr>
                        <th>文章模板</th>
            ...
            yes: function (index, layero) {
                ...
                var currentCatid="<?php echo $post_category_ids; ?>"
                  if(currentCatid != catid){
                    ...
                    $.ajax({
                      url:"<?php echo url('portal/AdminSource/getPosition','',false); ?>",
                      type:"GET",
                      data:{'catid':catid},
                      dataType:"JSON",
...
<script>
    ...
    var publishYesUrl = "<?php echo url('AdminSource/publish',array('yes'=>1)); ?>";
    var publishNoUrl = "<?php echo url('AdminSource/publish',array('no'=>1)); ?>";
    var topYesUrl = "<?php echo url('AdminSource/top',array('yes'=>1)); ?>";
    var topNoUrl = "<?php echo url('AdminSource/top',array('no'=>1)); ?>";
    var recommendYesUrl = "<?php echo url('AdminSource/recommend',array('yes'=>1)); ?>";
    var recommendNoUrl = "<?php echo url('AdminSource/recommend',array('no'=>1)); ?>";
