<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"themes/admin/portal\admin_categoryen\add.html";i:1561018441;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\admin\public\header.html";i:1543480324;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo url('AdminCategoryen/add'); ?>">添加分类</a></li>
    </ul>
    <div class="row margin-top-20">
        ...
        <div class="col-md-6">
            <form class="js-ajax-form" action="<?php echo url('AdminCategoryen/addPost'); ?>" method="post">
