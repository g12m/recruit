<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:36:"themes/index/user\\register_com.html";i:1599561007;}*/ ?>
<!DOCTYPE html>
<html>
...
<body style="background: url(/themes/index/public/assets/images/default/bg_clear.jpg)" class="register-form">
                ...
                <form action="<?php echo url('user/Register/doRegister'); ?>" method="POST">
                    ...
                    <div class="form-m">
                        ...
                        <div class="sctp width">
                            <label> 上传营业执照：</label>
                            <div class="scinput">
                                <input type="file" class="scbtn" id="yyzz" name="img" onclick="document.getElementById('file-up').click();">
                                <img class="img" id="demo1" src="/themes/index/public/assets/images/default/sc.png" alt="">
                            </div>
                    ...
                    <script src="/static/js/base64image.js" type="text/javascript"></script>
    ...
    <script>
        ...
        function sumitImageFile(base64Codes) {
            ...
            $.ajax({
                url: "<?php echo url('portal/list/avatarUpload'); ?>", //上传接口
                type: 'POST',
                cache: false,
                data: formData,
                processData: false,
