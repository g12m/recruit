<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:40:"themes/index/portal\sturesume\index.html";i:1599648061;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="layui-side layui-bg-black" style="background: url(/themes/index/public/assets/images/navbg.png);">
            ...
            <div class="layui-side-scroll">
                <ul class="layui-nav layui-nav-tree" lay-filter="test">
                    <li class="layui-nav-item layui-nav-itemed layui-this"><a href="javascript:;"><img src="/themes/index/public/assets/images/icon_jl.png" alt=""> 简历管理 <span
                                class="jian">></span></a></li>
                    <li class="layui-nav-item"><a href="<?php echo cmf_url('entposition/index'); ?>"><img src="/themes/index/public/assets/images/icon_zw.png" alt=""> 职位管理 <span
                                class="jian">></span></a></li>
