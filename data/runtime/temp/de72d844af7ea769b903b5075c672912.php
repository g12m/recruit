<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:32:"themes/admin/admin\user\add.html";i:1599439175;s:74:"E:\phpStudy\PHPTutorial\WWW\zhaopin\public\themes\admin\public\header.html";i:1599439176;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
				...
				<div class="col-md-6 col-sm-10">
					<?php if(is_array($roles) || $roles instanceof \think\Collection || $roles instanceof \think\Paginator): if( count($roles)==0 ) : echo "" ;else: foreach($roles as $key=>$vo): ?>
						<label class="checkbox-inline">
							<?php if(cmf_get_current_admin_id() != 1 && $vo['id'] != 1): ?>
								<input value="<?php echo $vo['id']; ?>" type="checkbox" name="role_id[]" ><?php echo $vo['name']; elseif(cmf_get_current_admin_id() == 1): ?>
							  <input value="<?php echo $vo['id']; ?>" type="checkbox" name="role_id[]" ><?php echo $vo['name']; endif; ?>
						</label>
