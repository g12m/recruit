...
<div class="xinwen-xiang" style="background-image: url(images/chanpin_bg.jpg); background-repeat: no-repeat;">
	<div class="container">
		<div class="top">
			<h3><?php echo $article['post_title']; ?></h3>
		<p><span>发布时间：<?php echo date("Y-m-d",$article['published_time']); ?></span><span>浏览：<?php echo $article['post_hits']; ?></span></p>
		</div>
		<div class="text">
		...
		<div class="bottom clearfix">
			<div class="fl">
					<?php if(!empty($next_article)): ?>
						<a
							href="<?php echo cmf_url('portal/Article/index',array('id'=>$next_article['id'],'cid'=>$category['id'])); ?>">上一篇：<?php echo $next_article['post_title']; ?></a>
						<?php else: ?>
						<a style="cursor:pointer;">上一篇：无</a>
					<?php endif; if(!empty($prev_article)): ?>
						<a
							href="<?php echo cmf_url('portal/Article/index',array('id'=>$prev_article['id'],'cid'=>$category['id'])); ?>">下一篇：<?php echo $prev_article['post_title']; ?></a>
						<?php else: ?>
						<a style="cursor:pointer;">下一篇：无</a>
					<?php endif; ?>
			</div>
			<div class="fr">
				<a href="<?php echo cmf_url('portal/List/index',array('id'=>$category['id'])); ?>">返回列表页</a>
			</div>
		</div>
	</div>
</div>
