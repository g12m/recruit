<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"themes/admin/portal\admin_stuquan\edit.html";i:1599975110;s:74:"E:\phpStudy\PHPTutorial\WWW\zhaopin\public\themes\admin\public\header.html";i:1599439176;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
    <div class="wrap js-check-wrap">
        <ul class="nav nav-tabs">
            <li class="active"><a href="javascript:;">修改属性</a></li>
            <li><a href="<?php echo url('AdminStuquan/index'); ?>">属性列表</a></li>
        </ul>
        <form method="post" class="form-horizontal js-ajax-form margin-top-20"
            action="<?php echo url('AdminStuquan/editPost'); ?>">
