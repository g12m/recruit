<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:50:"themes/admin/portal\admin_position_data\index.html";i:1563358397;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\admin\public\header.html";i:1543480324;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li class="active"><a href="<?php echo url('AdminPosition/index'); ?>">推荐位管理</a></li>
        <li ><a href="<?php echo url('AdminPosition/add'); ?>">添加推荐位</a></li>
    </ul>
    <form method="post" class="js-ajax-form margin-top-20" action="<?php echo url('AdminPositionData/listOrder'); ?>">

          <div class="table-actions">
              <button class="btn btn-primary btn-sm js-ajax-submit" type="submit"><?php echo lang('SORT'); ?></button>
              <button class="btn btn-danger btn-sm js-ajax-submit" type="submit"
                      data-action="<?php echo url('AdminPositionData/delete'); ?>" data-subcheck="true" data-msg="您确定删除吗？">
            ...
            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                <tr>
                  ...
                  <td><input name='list_orders[<?php echo $vo['id']; ?>]' class="input input-order mr5" type='text' size='3'
                    ...
                    <?php $name=get_article_info_byid($vo['article_id']);?>
                    <td><?php echo $name['post_title']; ?></td>
                    <td>
                      <span class="label label-default">
                          <a  style="color: #fff;" ><?php echo get_cat_info($vo['catid'])['name']; ?></a>
                      </span>
                    </td>
                    <td><?php echo $vo['name']; ?></td>
                    <td>
                        <a class="" href="<?php echo url('AdminArticle/edit',['id'=>$vo['article_id']]); ?>">原文编辑</a>|
                        <a class="js-ajax-delete" href="<?php echo url('AdminPositionData/delete',['id'=>$vo['id']]); ?>">删除</a>
                    </td>
                </tr>
