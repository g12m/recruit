...
<div data-scroll-reveal="enter bottom" class="banner">
  ...
  <?php endif; ?>
	...
	<div class="fuwu-xiang" style="background-image: url(images/chanpin_bg.jpg); background-repeat: no-repeat;">
		<div class="container">
			<h2><?php echo $article['post_title']; ?></h2>
			<?php echo $article['post_content']; ?>
			<a data-scroll-reveal="enter right" href="<?php echo cmf_url('portal/List/index',array('id'=>$category['id'])); ?>" class="fan">返回列表页</a>
		</div>
	</div>
