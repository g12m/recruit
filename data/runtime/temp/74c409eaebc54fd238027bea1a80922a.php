<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"themes/admin/portal\admin_position\edit.html";i:1562987383;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\admin\public\header.html";i:1543480324;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		...
		<form method="post" class="form-horizontal  margin-top-20" action="<?php echo url('AdminPosition/editPost'); ?>">
			<div class="form-group">
				<label for="input-user_login" class="col-sm-2 control-label"><span class="form-required">*</span>推荐位名称</label>
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control" id="input-user_login" name="name" value="<?php echo $info['name']; ?>">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6 col-sm-10">
					<input type="text" class="form-control" id="input-user_email" name="maxnum" value="<?php echo $info['maxnum']; ?>">
				</div>
			</div>
			<div class="form-group">
  ...
  <script type="text/javascript">
  var catid="<?php echo $info['catid']; ?>"
    $('#select-href').find('option').each(function(k,v){
      if($(v).attr('data-catid') == catid)
      {
