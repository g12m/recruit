<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:40:"themes/admin/portal\admin_about\add.html";i:1563332539;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\admin\public\header.html";i:1543480324;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="<?php echo url('AdminAbout/add'); ?>">添加文章</a></li>
    </ul>
    <form action="<?php echo url('AdminAbout/addPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                <table class="table table-bordered">
                    ...
                    <!-- <tr>
                        ...
                        <td>
                            <input class="form-control" type="text" name="post[post_title_en]"
                                   id="title_en"  value="" placeholder="请输入英文标题"/>
                        </td>
                    </tr> -->
                    <tr>
                        <th>关键词</th>
                    ...
                    <tr id="phone" style="display:none">
                        <th>招生对象</th>
                        <td>
                            <input class="form-control" type="text" name="post[post_phone]" id="phone" value=""
                                   placeholder="请输入招生对象">
                    ...
                    <tr id="email" style="display:none">
                        <th>行程天数</th>
                        <td>
                            <input class="form-control" type="text" name="post[post_email]" id="email" value=""
                                   placeholder="请输入行程天数">
                            <p class="help-block"></p>
                        </td>
                    </tr>
                    <tr id="url" style="display:none">
                        <th>出发城市</th>
                        <td>
                            <input class="form-control" type="text" name="post[post_url]" id="url" value=""
                                   placeholder="请输入出发城市">
                            <p class="help-block"></p>
                        </td>
                    </tr>
                    <tr id="year" style="display:none">
                        <th>费用</th>
                        <td>
                            <input class="form-control" type="text" name="post[post_year]" id="year" value=""
                                   placeholder="请输入费用">
                            <p class="help-block"></p>
                        </td>
                    </tr>
                    <!-- <tr id="zixun" style="display:none">
                        <th>在线咨询</th>
                        <td>
                            <input class="form-control" type="text" name="post[post_sex]" id="zixun" value=""
                                   placeholder="请输入在线咨询">
                            <p class="help-block"></p>
                        </td>
                    </tr> -->
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea class="form-control" name="post[post_excerpt]" style="height: 50px;"
                                      placeholder="自动提取内容前200个字符"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>内容</th>
                    ...
                    <tr id="ke" style="display:none">
                        <th>课程详情</th>
                        <td>
                            <script type="text/plain" id="content1" name="post[post_case]"></script>
                        </td>
                    </tr>
                    <tr id="xing" style="display:none">
                        <th>行程安排</th>
                        <td>
                            <script type="text/plain" id="content2" name="post[post_xing]"></script>
                        </td>
                    </tr>
                    <tr id="kai" style="display:none">
                        <th>开营时间</th>
                        <td>
                            <script type="text/plain" id="content3" name="post[post_time]"></script>
                        </td>
                    </tr>
                    <tr id="fu" style="display:none">
                        <th>付款方式</th>
                        <td>
                            <script type="text/plain" id="content4" name="post[post_pay]"></script>
                        </td>
                    </tr>
                    <tr id="jia" style="display:none">
                        <th>家长评价</th>
                        <td>
                            <script type="text/plain" id="content5" name="post[post_apply]"></script>
                        </td>
                    </tr>
                    <tr id="bao" style="display:none">
                        <th>报名须知</th>
                        <td>
                            <script type="text/plain" id="content6" name="post[post_baoming]"></script>
                        </td>
                    </tr>
                    <tr>
                        <th>相册</th>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a class="btn btn-default" href="<?php echo url('AdminAbout/index'); ?>"><?php echo lang('BACK'); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <table class="table table-bordered">
                    ...
                    <tr>
                        <td>
                            <div style="text-align: center;">
                                <input type="hidden" name="post[more][thumbrecomm]" id="thumbrecomm" value="">
    ...
    function doSelectCategory() {
        ...
        openIframeLayer("<?php echo url('AdminCategory/select'); ?>?ids=" + selectedCategoriesId+ "&cid="+'2', '请选择分类', {
            ...
            yes: function (index, layero) {
                ...
                $('#js-categories-id-input').val(catid);
                $('#js-categories-name-input').val(selectedCategories.selectedCategoriesName.join(' '));

                // if(catid==10 || catid==11 || catid==9)
                // {
                //   $("#phone").show();
                //   $("#email").show();
                //   $("#url").show();
