<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:44:"themes/admin/portal\admin_stuquan\index.html";i:1599977555;s:74:"E:\phpStudy\PHPTutorial\WWW\zhaopin\public\themes\admin\public\header.html";i:1599439176;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap js-check-wrap">
		<ul class="nav nav-tabs">
			<li class="active"><a href="<?php echo url('AdminStuquan/index'); ?>"><?php echo lang('权限列表'); ?></a></li>
			<li><a href="<?php echo url('AdminStuquan/add'); ?>"><?php echo lang('添加权限'); ?></a></li>
		</ul>
				...
				<tbody>
					...
					<tr>
						...
						<td>
								...
								<a href="<?php echo url('AdminStuquan/edit',array('id'=>$vo['id'])); ?>"><?php echo lang('EDIT'); ?></a>
								<a class="js-ajax-delete" href="<?php echo url('AdminStuquan/delete',array('id'=>$vo['id'])); ?>"><?php echo lang('DELETE'); ?></a>	
						</td>
					</tr>
