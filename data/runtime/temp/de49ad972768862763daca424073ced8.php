<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:37:"themes/admin/admin\nav_menu\edit.html";i:1599439175;s:74:"E:\phpStudy\PHPTutorial\WWW\zhaopin\public\themes\admin\public\header.html";i:1599439176;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    $(function () {
        ...
        $("#select-href").change(function () {
            ...
            var catid = $this.find("option[value='" + $this.val() + "']").data('catid');
