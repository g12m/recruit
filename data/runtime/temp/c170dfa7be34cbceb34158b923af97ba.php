<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:39:"themes/admin/portal\admin_res\edit.html";i:1563345683;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\admin\public\header.html";i:1543480324;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('AdminRes/index'); ?>">文章管理</a></li>
        <li>
            <a href="<?php echo url('AdminRes/add'); ?>">添加文章</a>
        </li>
        <li class="active"><a href="#">编辑文章</a></li>
    </ul>
    <form action="<?php echo url('AdminRes/editPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
...
<script type="text/javascript">
    ...
    function doSelectCategory() {
        ...
        openIframeLayer("<?php echo url('AdminCategory/select'); ?>?ids=" + selectedCategoriesId+ "&cid="+'3', '请选择分类', {
            area: ['700px', '400px'],
            btn: ['确定', '取消'],
            yes: function (index, layero) {
                ...
                var currentCatid="<?php echo $post_category_ids; ?>"
                  if(currentCatid != catid){
                    ...
                    $.ajax({
                      url:"<?php echo url('portal/AdminRes/getPosition','',false); ?>",
                      type:"GET",
                      data:{'catid':catid},
                      dataType:"JSON",
...
<script>
    ...
    var publishYesUrl = "<?php echo url('AdminRes/publish',array('yes'=>1)); ?>";
    var publishNoUrl = "<?php echo url('AdminRes/publish',array('no'=>1)); ?>";
    var topYesUrl = "<?php echo url('AdminRes/top',array('yes'=>1)); ?>";
    var topNoUrl = "<?php echo url('AdminRes/top',array('no'=>1)); ?>";
    var recommendYesUrl = "<?php echo url('AdminRes/recommend',array('yes'=>1)); ?>";
    var recommendNoUrl = "<?php echo url('AdminRes/recommend',array('no'=>1)); ?>";
