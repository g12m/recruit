<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"themes/admin/portal\admin_positionen\add.html";i:1553153872;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\admin\public\header.html";i:1543480324;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			<li><a href="<?php echo url('AdminPositionen/index'); ?>">推荐位管理</a></li>
			<li class="active"><a>添加</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form margin-top-20" action="<?php echo url('AdminPositionen/addPost'); ?>">
