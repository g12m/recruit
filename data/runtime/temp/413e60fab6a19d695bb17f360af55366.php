<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:36:"themes/index/portal\list_museum.html";i:1563356097;s:68:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\index\public\base.html";i:1543484706;s:68:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\index\public\head.html";i:1563266601;s:75:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\index\public\header_list.html";i:1563428023;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\index\public\banner.html";i:1563354765;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\index\public\footer.html";i:1563267248;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="fuwu" style="background-image: url(/themes/index/public/assets/images/default/chanpin_bg.jpg); background-repeat: no-repeat;">
    <div class="container">
        <div data-scroll-reveal="enter left" class="fuwu-top">
            <h2>服务支持</h2>
            <p>
                <?php
...
$__PAGE_VAR_NAME__ = isset($articles_data['page'])?$articles_data['page']:'';
 ...
 if(is_array($articles_data['articles']) || $articles_data['articles'] instanceof \think\Collection || $articles_data['articles'] instanceof \think\Paginator): $i = 0; $__LIST__ = $articles_data['articles'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
            ...
            <div data-scroll-reveal="enter right" class="fl">
                <div class="img">
                ...
                <div class="text">
                    <a href="<?php echo cmf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$category['id'])); ?>"><h3><?php echo $vo['post_title']; ?></h3></a>
                    <p><?php echo $vo['post_excerpt']; ?></p>
                    <a href="<?php echo cmf_url('portal/Article/index',array('id'=>$vo['id'],'cid'=>$category['id'])); ?>">更多...</a>
                </div>
            </div>
