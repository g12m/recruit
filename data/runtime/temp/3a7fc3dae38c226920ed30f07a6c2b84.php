<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"themes/admin/portal\admin_productsen\add.html";i:1563429484;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\admin\public\header.html";i:1543480324;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('AdminProductsen/index'); ?>">文章管理</a></li>
        <li class="active"><a href="<?php echo url('AdminProductsen/add'); ?>">添加文章</a></li>
    </ul>
    <form action="<?php echo url('AdminProductsen/addPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a class="btn btn-default" href="<?php echo url('AdminProductsen/index'); ?>"><?php echo lang('BACK'); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
...
<script type="text/javascript">
    ...
    function doSelectCategory() {
        ...
        openIframeLayer("<?php echo url('AdminCategoryen/select'); ?>?ids=" + selectedCategoriesId+ "&cid="+'4', '请选择分类', {
            area: ['700px', '400px'],
            btn: ['确定', '取消'],
            yes: function (index, layero) {
                ...
                if(catid==10 || catid==11 || catid==12 || catid==13  || catid==14)
                {
                  $("#phone").show();
                  $("#email").show();
                  $("#url").show();
                ...
                //动态追加 推荐位2018.8.17
                $.ajax({
                  url:"<?php echo url('portal/AdminProductsen/getPosition','',false); ?>",
                  type:"GET",
                  data:{'catid':catid},
                  dataType:"JSON",
