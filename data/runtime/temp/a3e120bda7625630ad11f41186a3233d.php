<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"themes/admin/portal\admin_sourceen\add.html";i:1561024357;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\admin\public\header.html";i:1543480324;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('AdminSourceen/index'); ?>">文章管理</a></li>
        <li class="active"><a href="<?php echo url('AdminSourceen/add'); ?>">添加文章</a></li>
    </ul>
    <form action="<?php echo url('AdminSourceen/addPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a class="btn btn-default" href="<?php echo url('AdminSourceen/index'); ?>"><?php echo lang('BACK'); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
...
<script type="text/javascript">
    ...
    function doSelectCategory() {
        ...
        openIframeLayer("<?php echo url('AdminCategoryen/select'); ?>?ids=" + selectedCategoriesId+ "&cid="+'5', '请选择分类', {
            area: ['700px', '400px'],
            btn: ['确定', '取消'],
            yes: function (index, layero) {
                ...
                //动态追加 推荐位2018.8.17
                $.ajax({
                  url:"<?php echo url('portal/AdminSourceen/getPosition','',false); ?>",
                  type:"GET",
                  data:{'catid':catid},
                  dataType:"JSON",
