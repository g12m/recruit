<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:42:"themes/admin/portal\admin_conween\add.html";i:1563429745;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\admin\public\header.html";i:1543480324;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('AdminConween/index'); ?>">文章管理</a></li>
        <li class="active"><a href="<?php echo url('AdminConween/add'); ?>">添加文章</a></li>
    </ul>
    <form action="<?php echo url('AdminConween/addPost'); ?>" method="post" class="form-horizontal js-ajax-form margin-top-20">
        <div class="row">
            <div class="col-md-9">
                <table class="table table-bordered">
                    ...
                    <tr id="sex" style="display:none">
                        <th>性别要求</th>
                        <td>
                            <input class="form-control" type="text" name="post[post_sex]" id="sex" value=""
                                   placeholder="请输入性别要求">
                            <p class="help-block"></p>
                        </td>
                    </tr>
                    <tr id="china" style="display:none">
                        <th>语言要求</th>
                        <td>
                            <input class="form-control" type="text" name="post[post_china]" id="china" value=""
                                   placeholder="请输入语言要求">
                            <p class="help-block"></p>
                        </td>
                    </tr>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        ...
                        <a class="btn btn-default" href="<?php echo url('AdminConween/index'); ?>"><?php echo lang('BACK'); ?></a>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
...
<script type="text/javascript">
    ...
    function doSelectCategory() {
        ...
        openIframeLayer("<?php echo url('AdminCategoryen/select'); ?>?ids=" + selectedCategoriesId+ "&cid="+'6', '请选择分类', {
            area: ['700px', '400px'],
            btn: ['确定', '取消'],
            yes: function (index, layero) {
                ...
                //动态追加 推荐位2018.8.17
                $.ajax({
                  url:"<?php echo url('portal/AdminConween/getPosition','',false); ?>",
                  type:"GET",
                  data:{'catid':catid},
                  dataType:"JSON",
