<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:30:"themes/admin/admin\\login.html";i:1599883599;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8"/>
    <title>在线招聘-后台管理系统</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-md-offset-4">
                <h1 class="text-center" style="color:white">在线招聘管理系统</h1>
