<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:46:"themes/admin/portal\admin_categoryen\edit.html";i:1563428386;s:70:"E:\phpStudy\PHPTutorial\WWW\xsj\public\themes\admin\public\header.html";i:1543480324;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    <ul class="nav nav-tabs">
        <li><a href="<?php echo url('AdminCategoryen/index'); ?>">分类管理</a></li>
    ...
    <div class="row margin-top-20">
        ...
        <div class="col-md-6">
            <form class="js-ajax-form" action="<?php echo url('AdminCategoryen/editPost'); ?>" method="post">
                <div class="tab-content">
                    <div class="tab-pane active" id="A">
                        ...
                        <div class="form-group">
                            <label for="input-name"><span class="form-required">*</span>首页图标</label>
                            <div>
                                <input type="text" class="form-control" id="input-name_en" name="name_en" value="<?php echo $name_en; ?>">
                            </div>
                        </div>
                        ...
                        <!-- <div class="form-group">
                            <label for="input-description">背景缩略图</label>
                            <div>
                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <input type="hidden" name="more[thumbnail_shou]" class="form-control"
                                       value="<?php echo (isset($more['thumbnail_shou']) && ($more['thumbnail_shou'] !== '')?$more['thumbnail_shou']:''); ?>" id="js-thumbnail_shou-input">
                                <div>
                                    <a href="javascript:uploadOneImage('图片上传','#js-thumbnail_shou-input');">
                                        <?php if(empty($more['thumbnail_shou'])): ?>
                                            <img src="/themes/admin/public/assets/images/default-thumbnail.png"
                                                 id="js-thumbnail_shou-input-preview"
                                                 width="135" style="cursor: pointer"/>
                                            <?php else: ?>
                                            <img src="<?php echo cmf_get_image_preview_url($more['thumbnail_shou']); ?>"
                                                 id="js-thumbnail_shou-input-preview"
                                            width="135" style="cursor: pointer"/>
                                        <?php endif; ?>
                                    </a>
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div>
                                <input type="hidden" name="more[thumbnail_cat]" class="form-control"
                                       value="<?php echo (isset($more['thumbnail_cat']) && ($more['thumbnail_cat'] !== '')?$more['thumbnail_cat']:''); ?>" id="js-thumbnail_cat-input">
                                <div>
                                    <a href="javascript:uploadOneImage('图片上传','#js-thumbnail_cat-input');">
                                        <?php if(empty($more['thumbnail_cat'])): ?>
                                            <img src="/themes/admin/public/assets/images/default-thumbnail.png"
                                                 id="js-thumbnail_cat-input-preview"
                                                 width="135" style="cursor: pointer"/>
                                            <?php else: ?>
                                            <img src="<?php echo cmf_get_image_preview_url($more['thumbnail_cat']); ?>"
                                                 id="js-thumbnail_cat-input-preview"
                                            width="135" style="cursor: pointer"/>
                                        <?php endif; ?>
                                    </a>
                ...
                <div class="form-group">
                    ...
                    <a class="btn btn-default" href="<?php echo url('AdminCategoryen/index'); ?>"><?php echo lang('BACK'); ?></a>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    $('.btn-cancel-thumbnail').click(function () {
        $('#js-thumbnail-input-preview').attr('src', '/themes/admin/public/assets/images/default-thumbnail.png');
        $('#js-thumbnail-input').val('');
    });
    $('.btn-cancel-thumbnail_m').click(function () {
        $('#js-thumbnail_m-input-preview').attr('src', '/themes/admin/public/assets/images/default-thumbnail.png');
        $('#js-thumbnail_m-input').val('');
    });
    $('.btn-cancel-thumbnail_shou').click(function () {
        $('#js-thumbnail_shou-input-preview').attr('src', '/themes/admin/public/assets/images/default-thumbnail.png');
        $('#js-thumbnail_shou-input').val('');
    });
    $('.btn-cancel-thumbnail_cat').click(function () {
        $('#js-thumbnail_cat-input-preview').attr('src', '/themes/admin/public/assets/images/default-thumbnail.png');
