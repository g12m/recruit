 ...
 */
    public function __construct()
    {
        ...
        $this->mch_appid        = "xxxxxxxxxxxxx";//公众号appid
        $this->mchid            = "XXXXXXXX"; //商户号
        $this->signKey          = 'dfadgakdhgkajdhfiauwefiuawheif';
        //=======【证书路径设置】=====================================
        /**
         * TODO：设置商户证书路径
         ...
         * @var path
         */
        $this->api_cert         = 'Wxpay/cacert/apiclient_cert.pem';
        $this->api_key          = 'Wxpay/cacert/apiclient_key.pem';
        $this->api_rootca       = 'Wxpay/cacert/rootca.pem';
     ...
     * @return array|mixed
     */
    protected function companyToPocket($openid, $amount, $order_sn, $desc, $ip)
    {
        $this->config    = array(
            "mch_appid" => $this->mch_appid,
            'mchid'     => $this->mchid,
